...
| Control de versiones y trazabilidad | Commits atómicos, diffs, ramas, revisión de cambios (PRs), bisect, revertir, y conservación versionada de las conversaciones/prompts con el agente que originaron cada cambio | Es el mecanismo con el que se audita, aprueba y responde de cada cambio -propio o generado por IA-; el diff dice qué cambió, pero solo la conversación conservada dice por qué se le pidió y con qué razonamiento, que es lo que sostiene la responsabilidad verificable |
